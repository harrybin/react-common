...
function useGuaranteedMemo(fn, deps) {
    const [ref] = React.useState({ "current": undefined });
...
const useMuiThemeStyleOverridesPlugin = ({ classes, theme, muiStyleOverridesParams, css, cx, name }) => {
    ...
    const classesFromThemeStyleOverrides = React.useMemo(() => {
    ...
    classes = React.useMemo(() => mergeClasses(classes, classesFromThemeStyleOverrides, cx), [classes, classesFromThemeStyleOverrides, cx]);
    return { classes };
};
        ...
        return function (cssObjectByRuleNameOrGetCssObjectByRuleName) {
            ...
            return function useStyles(params, muiStyleOverridesParams) {
                ...
                }, [cache, css, cx, theme, getDependencyArrayRef(params)]);
                {
                    ...
                    classes = React.useMemo(() => mergeClasses(classes, propsClasses, cx), [classes, getDependencyArrayRef(propsClasses), cx]);
                }
                {
...
const { createUseCache } = (() => {
    function useCacheProvidedByProvider() {
        const cacheExplicitlyProvidedForTss = React.useContext(reactContext);
...
function createWithStyles(params) {
    ...
    function withStyles(Component, cssObjectByRuleNameOrGetCssObjectByRuleName, params) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const Out = React.forwardRef(function (props, ref) {
    ...
    return {
        ...
        "create": (cssObjectByRuleNameOrGetCssObjectByRuleName) => {
            ...
            return function useStyles(params) {
                ...
                classes = React.useMemo(() => mergeClasses(classes, classesOverrides, cx), [classes, getDependencyArrayRef(classesOverrides), cx]);
                // @ts-expect-error: Type safety non achievable.
...
function Markdown(props) {
    ...
    const options = {
        overrides: {
            ...
            a: { component: Link },
            li: {
                component: (liProps) => (React.createElement("li", { className: classes.listItem },
                    React.createElement(Typography, Object.assign({}, liProps)))),
            },
        },
    };
    const { options: passedOpt } = props, restProps = __rest$2(props, ["options"]);
    const mergedOptions = _.merge(options, passedOpt);
    return React.createElement(ReactMarkdown, Object.assign({ options: mergedOptions }, restProps));
}
...
function NameValueTextComp(props) {
    ...
    return (React.createElement("div", { className: props.verticalSpacing ? props.verticalSpacing : classes.padding },
        React.createElement(material.Grid, { container: true, direction: props.oneLine ? 'row' : 'column' },
            ...
            React.createElement(material.Grid, { item: true }, typeof props.value === 'string' ? (React.createElement(material.Typography, { variant: "body1", className: css.cx(classes.nameValueText, classes.value) }, props.value)) : (React.createElement(React.Fragment, null,
                props.value,
                props.children))))));
}
...
function ConfirmationDialog(props) {
    ...
    return (React.createElement(Dialog, Object.assign({ disableEscapeKeyDown: true, fullScreen: props.fullScreen, maxWidth: (_a = props.maxWidth) !== null && _a !== void 0 ? _a : 'xs', "aria-labelledby": "confirmation-dialog-title", open: open, onClose: undefined }, other),
        React.createElement(DialogTitle, { id: "confirmation-dialog-title", className: classes.header }, title),
        React.createElement(DialogContent, { dividers: true, className: props.fullScreen ? classes.dialogContentFull : classes.dialogContent },
            text && React.createElement(material.Typography, null, typeof text === 'string' ? text : text()),
            props.children),
        React.createElement(DialogActions, null,
            okLable !== undefined && (React.createElement(Button, { id: "button_confirmOk", onClick: handleOk, color: "primary", variant: props.isRightButtonHighlighted ? 'text' : 'contained', disabled: props.leftButtonDisabled }, okLable !== '' ? okLable : 'common_ok')),
            cancelLable !== undefined && (React.createElement(Button, { id: "button_confirmCancel", variant: props.isRightButtonHighlighted ? 'contained' : 'text', autoFocus: true, onClick: handleCancel, color: "primary" }, cancelLable !== '' ? cancelLable : 'common_cancel')))));
}
...
const defaultErrorDescriptions = {
    descMsg: 'Here you can send an error report. Please provide a detailed description, tell us how to reproduce the issue und fill the contact field making us able to contact you in case we have further questions.',
...
const ErrorReportDialogComp = (props) => {
    const { classes } = useStyles();
    const [desc, setDesc] = React__namespace.useState('');
    const [repro, setRepro] = React__namespace.useState('');
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(material.Box, { margin: "20px" },
            React__namespace.createElement(material.Grid, { container: true, direction: "row", spacing: 2 },
                React__namespace.createElement(material.Grid, { item: true, xs: 12 },
...
function isArray(obj) {
    if (Array.isArray)
        ...
        throw new Error('Polyfill for "Array.isArray" is missing.');
}
/**
 ...
 * @returns
 */
function removeFromArray(arr, value, key) {
 ...
 * @return {*}  {Date}
 */
function getLatestDateof(dates) {
    if (dates.length === 0)
        return undefined;
    let latest = dates[0];
    dates.forEach((date) => {
 ...
 * @returns {T}
 */
function createPartialObject(fullEntity, properties) {
    const result = {};
    if (properties) {
 ...
 * @returns {T}
 */
function createPartialWithIdAndOptLock(fullEntity, properties) {
    const result = { id: fullEntity.id, optLock: fullEntity.optLock };
    if (properties) {
        for (const prop of properties) {
            const propName = prop;
            result[propName] = fullEntity[propName];
...
const baererContext = React__namespace.createContext('');
let bearer = '';
/*
 ...
 */
function OidcBarerProxyProvider(props) {
    const regEx = /auth=(.*)/;
    ...
    return React__namespace.createElement(baererContext.Provider, { value: bearer }, props.children);
}
function useOidcBaerer() {
    return React__namespace.useContext(baererContext);
}
 ...
 */
function createCommonHeaders(eTag, oidcBaerer) {
    const headers = new Headers();
    headers.append('Content-Type', 'application/json');
    if (oidcBaerer)
        headers.append('Authorization', 'Bearer ' + oidcBaerer);
    if (eTag)
        headers.append('If-Match', '"' + eTag + '"');
    return headers;
}
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const globalStaticResponseDict = {};
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const staticDataDict = {};
// eslint-disable-next-line @typescript-eslint/ban-types
function useFetch() {
     ...
     * @return {*}  {(T | T[])}
     */
    function partialDataProblemTypeErrorHandler(responseJson, handleCustomErrorData) {
        if (!responseJson)
            return responseJson;
        handleCustomErrorData && handleCustomErrorData(responseJson);
        return responseJson;
    }
    function ensureLangUrlParam(url, customQueryParam) {
        const teststr = `${customQueryParam.name}=`;
        if (url.indexOf(teststr) <= 0) {
            if (url.indexOf('?') <= 0)
                return `${url}?${customQueryParam.name}=${customQueryParam.value}`;
            else
                return `${url}&${customQueryParam.name}=${customQueryParam.value}`;
        }
        return url;
    ...
    function loadDataAsync(props) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const queryString = props.customQueryParam
                    ? ensureLangUrlParam(props.queryString, props.customQueryParam)
                    : props.queryString;
                if (queryString === props.lastQuery)
                    return undefined;
                const headers = createCommonHeaders(undefined, oidcBaerer);
                (_a = props.customHeaderList) === null || _a === void 0 ? void 0 : _a.forEach((customHeader) => headers.append(customHeader.name, customHeader.value));
                const result = yield fetch(queryString, {
                    method: 'GET',
                    headers: headers,
                    cache: 'no-store',
                })
                    ...
                    if (props.handleExceptionCallback)
                        props.handleExceptionCallback(ex);
                    else {
                        if (errorHandler.exceptionHanlder)
                            errorHandler.exceptionHanlder(ex);
                        else
                            throw ex;
                    }
                });
    ...
    function updateDataAsync(props) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            const queryString = props.customQueryParam
                ? ensureLangUrlParam(props.queryString, props.customQueryParam)
            ...
            if (props.eTag === undefined && ((_a = props.data) === null || _a === void 0 ? void 0 : _a.hasOwnProperty('optLock'))) {
                props.eTag = props.data.optLock;
            }
            props.setIsLoadingCallback && props.setIsLoadingCallback(true);
            const headers = createCommonHeaders((_b = props.eTag) === null || _b === void 0 ? void 0 : _b.toString(), oidcBaerer);
            (_c = props.customHeaderList) === null || _c === void 0 ? void 0 : _c.forEach((customHeader) => headers.append(customHeader.name, customHeader.value));
            return fetch(queryString, {
                ...
                if (props.noResultExpected)
                    return true;
                props.customResponseHandler && props.customResponseHandler(response);
                //special handling for DELETE request, usually only give status 200 without any data
                if (props.method === 'DELETE' || !props.data) {
                    return response.json().then((json) => json !== null && json !== void 0 ? json : true);
                }
                const eTagHeader = response.headers.get('eTag');
                if (eTagHeader)
                    props.eTag = parseInt(eTagHeader.replace('"', ''));
                props.setIsLoadingCallback && props.setIsLoadingCallback(false);
                return response.json();
            })
                .then((data) => {
                if (data) {
                    ...
                    props.data.optLock = data.optLock;
     ...
     */
    function loadStaticDataAsync(props) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryString = props.customQueryParam
                ? ensureLangUrlParam(props.queryString, props.customQueryParam)
                : props.queryString;
    ...
    function resetStaticData(query, customQueryParam) {
        const queryString = customQueryParam ? ensureLangUrlParam(query, customQueryParam) : query;
...
exports.SuspenseStatus = void 0;
(function (SuspenseStatus) {
    SuspenseStatus["Pending"] = "pending";
    SuspenseStatus["Success"] = "success";
    SuspenseStatus["Error"] = "error";
})(exports.SuspenseStatus || (exports.SuspenseStatus = {}));
function suspend(promise) {
    let status = exports.SuspenseStatus.Pending;
    let result;
    let error;
    let suspender = promise.then((value) => {
        status = exports.SuspenseStatus.Success;
        result = value;
    }, (err) => {
        status = exports.SuspenseStatus.Error;
        error = err;
    });
    return {
        query() {
            switch (status) {
                case exports.SuspenseStatus.Pending:
                    throw suspender;
                case exports.SuspenseStatus.Error:
                    throw error;
                case exports.SuspenseStatus.Success:
                default:
                    return result;
            }
        },
 ...
 */
const queryPromiseCache = new Map();
/**
...
function useQuery(props) {
    ...
    if (!wrappedPromise) {
        const promise = new Promise((resolve, _) => __awaiter(this, void 0, void 0, function* () {
            // Send request
            //const response = await fetch(url, { headers: defaultHeaders });
            const data = (yield loadDataAsync(props));
            resolve(data);
        }));
        // Wrap the promise to comply with the contract of the Suspense API
        wrappedPromise = suspend(promise);
 ...
 * Wrapped promises are being cached until the component is unmounted.
 */
const updatePromiseCache = new Map();
/**
 * Returns undefined or the data returned by the query. Until that point in time,
 * throws promises or exception in compliance with the React Suspense API. Hence,
 * expects to be wrapped by a Suspense component.
...
function useUpdate(props) {
    ...
    if (!wrappedPromise) {
        const promise = new Promise((resolve, _) => __awaiter(this, void 0, void 0, function* () {
            // Send update request
            const data = (yield updateDataAsync(props));
            resolve(data);
        }));
        // Wrap the promise to comply with the contract of the Suspense API
        wrappedPromise = suspend(promise);
...
exports.NameValueText = NameValueText;
exports.OidcBarerProxyProvider = OidcBarerProxyProvider;
exports.areArraysEqual = areArraysEqual;
exports.cloneData = cloneData;
exports.compareDate = compareDate;
exports.createCommonHeaders = createCommonHeaders;
exports.createPartialObject = createPartialObject;
exports.createPartialWithIdAndOptLock = createPartialWithIdAndOptLock;
...
exports.useOidcBaerer = useOidcBaerer;
exports.useOnScreen = useOnScreen;
exports.usePersistedReducer = usePersistedReducer;
exports.usePersistedRef = usePersistedRef;
exports.usePersistedState = usePersistedState;
exports.usePersistedStateOneway = usePersistedStateOneway;
exports.usePrevious = usePrevious;
exports.usePropsChanged = usePropsChanged;
