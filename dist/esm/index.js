...
import React__default, { useRef, useMemo, useContext, createContext, forwardRef, createElement, useEffect, useState, useReducer } from 'react';
...
function Markdown(props) {
    ...
    const options = {
        overrides: {
            ...
            a: { component: Link },
            li: {
                component: (liProps) => (React__default.createElement("li", { className: classes.listItem },
                    React__default.createElement(Typography, Object.assign({}, liProps)))),
            },
        },
    };
...
function NameValueTextComp(props) {
    ...
    return (React__default.createElement("div", { className: props.verticalSpacing ? props.verticalSpacing : classes.padding },
        React__default.createElement(Grid, { container: true, direction: props.oneLine ? 'row' : 'column' },
            ...
            React__default.createElement(Grid, { item: true }, typeof props.value === 'string' ? (React__default.createElement(Typography$1, { variant: "body1", className: cx(classes.nameValueText, classes.value) }, props.value)) : (React__default.createElement(React__default.Fragment, null,
                props.value,
                props.children))))));
}
const NameValueText = React__default.memo(NameValueTextComp);
...
function ConfirmationDialog(props) {
    ...
    return (React__default.createElement(Dialog, Object.assign({ disableEscapeKeyDown: true, fullScreen: props.fullScreen, maxWidth: (_a = props.maxWidth) !== null && _a !== void 0 ? _a : 'xs', "aria-labelledby": "confirmation-dialog-title", open: open, onClose: undefined }, other),
        React__default.createElement(DialogTitle, { id: "confirmation-dialog-title", className: classes.header }, title),
        React__default.createElement(DialogContent, { dividers: true, className: props.fullScreen ? classes.dialogContentFull : classes.dialogContent },
            text && React__default.createElement(Typography$1, null, typeof text === 'string' ? text : text()),
            props.children),
        React__default.createElement(DialogActions, null,
            okLable !== undefined && (React__default.createElement(Button, { id: "button_confirmOk", onClick: handleOk, color: "primary", variant: props.isRightButtonHighlighted ? 'text' : 'contained', disabled: props.leftButtonDisabled }, okLable !== '' ? okLable : 'common_ok')),
            cancelLable !== undefined && (React__default.createElement(Button, { id: "button_confirmCancel", variant: props.isRightButtonHighlighted ? 'contained' : 'text', autoFocus: true, onClick: handleCancel, color: "primary" }, cancelLable !== '' ? cancelLable : 'common_cancel')))));
}
...
const ErrorReportDialog = React.memo(ErrorReportDialogComp);
...
function usePersistedStateOneway(prefix, key, defaultValue) {
    const [state, setState] = React__default.useState(defaultValue);
...
function usePersistedRef(key, defaultValue) {
    const ref = React__default.useRef(defaultValue);
...
function useDebugMode() {
    const [isInDebugMode, setIsInDebugMode] = React__default.useState(false);
    const [debugChangesApplied, setDebugChangesApplied] = React__default.useState(false);
...
const baererContext = React.createContext('');
let bearer = '';
/*
...
function OidcBarerProxyProvider(props) {
    ...
    return React.createElement(baererContext.Provider, { value: bearer }, props.children);
}
