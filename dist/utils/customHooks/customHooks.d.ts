import React, { EffectCallback, DependencyList, SetStateAction, Dispatch, ReducerState, Reducer } from 'react';
/**
 ...
 */
export declare const useEffectDebugger: (effectHook: EffectCallback, dependencies: DependencyList, dependencyNames?: string[]) => void;
/**
...
export declare function usePersistedReducer<R extends Reducer<any, any>, T>(reducer: R, defaultState: T, key: string, initFunc?: (arg: T) => ReducerState<R>): [ReducerState<R>, Dispatch<Parameters<R>[1]>];
/**
 *
